...
v <- as.numeric(file2$Voltage)
z <- as.numeric(file2$Global_reactive_power)

png("plot4.png", width = 480, height = 480)
par(mfrow = c(2,2))

plot(datetime, x, type = "l", xlab = "", ylab = "Global Active Power")
...
plot(datetime, z, type = "l", ylab = "Global_reactive_power", xlab = "datetime", col = "black")
